...
$blogpostType = gt3_get_theme_option('default_blogpost_style');
if (isset($gt3_theme_pagebuilder['settings']['blogpost_style'])) {	
	if ($gt3_theme_pagebuilder['settings']['blogpost_style'] == 'simple-blogpost') { 
		$blogpostType = 'simple-blogpost';
	}
	if ($gt3_theme_pagebuilder['settings']['blogpost_style'] == 'fw-blogpost') { 
		$blogpostType = 'fw-blogpost';
	}
}
if ($blogpostType == 'fw-blogpost') {
	get_header('fullscreen');
} else {
	get_header();
}
the_post();
if ($blogpostType == 'simple-blogpost') { ?>
                    ...
                    <div class="row">						
                        <div class="posts-block simple-post <?php echo($gt3_theme_pagebuilder['settings']['layout-sidebars'] == "left-sidebar" ? "hasLS" : ""); ?>">
                            ...
                            <div class="contentarea">
                                        ...
                                        <div class="blog_post_page">
                                            <div class="simple-post-top">
                                                ...
                                                <section class="listing_meta">
                                                    ...
                                                    <?php the_tags("<span>". __('tags', 'theme_localization') .": ", ', ', '</span>'); ?>
                                                </section>
											</div>
                                            ...
                                            <section class="blogpost_user_meta">
                                                ...
                                                <div class="author-name"><h3><?php _e('About The Author', 'theme_localization'); ?>: <?php the_author_posts_link(); ?></h3></div>
                                                <div
                                ...
                                heading_color=''
                                heading_size='h3'
                                heading_text='" . __('Related Posts', 'theme_localization') . "'
                                            ...
                                            <div class="blog_post_page">
                                                <div class="simple-post-top">
                                                    ...
                                                    <section class="listing_meta">
                                                        ...
                                                        <span><?php _e('by', 'theme_localization'); ?> <?php echo the_author_posts_link(); ?></span>
                                                        <span><?php _e('in', 'theme_localization'); ?> <?php the_category(', '); ?></span>
                                                        <?php the_tags("<span>". __('by', 'theme_localization') .": ", ', ', '</span>'); ?>
                                                    </section>
                                                </div>
                                                <div class="blog_post_content">
                                                    <article class="contentarea">
