                            ...
                            <div class="contentarea">
                                ...
                                if ($paged < 1) {
                                    ...
                                    while ($query->have_posts()) : $query->the_post();									
										...
										?>
                                        <div <?php post_class("blog_post_preview search_page"); ?>>
                                            <div class="blog_content">
                                                <section class="box_date">
                                                    <span class="box_month"><?php the_time("M") ?></span>
                                                    <span class="box_day"><?php the_time("d") ?></span>
                                                </section>
                                                <h3 class="blogpost_title"><a href="<?php the_permalink(); ?>"><?php the_title(); ?></a></h3>
                                                <section class="listing_meta">
                                                    <span><?php _e('by', 'theme_localization'); ?> <?php the_author_meta('display_name'); ?></span>
                                                    <span><a href="<?php echo get_comments_link() ?>"><?php echo get_comments_number(get_the_ID()) ?> comments</a></span>
