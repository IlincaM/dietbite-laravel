...
class UploadOption_admin_theme extends Option_admin_theme
{
	protected function render_control()
	{
		...
		if(!empty($this->value)){
			$control .= '<a class="admin_uploaded-image" href="'. esc_url($this->value) . '" target="_blank"><img class="admin_option-image" id="image_'. $this->params['id'].'" src="'.esc_url($this->value).'" alt="" /></a>';
		}
