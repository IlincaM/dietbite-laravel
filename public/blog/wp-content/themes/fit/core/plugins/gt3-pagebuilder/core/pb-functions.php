...
if (!function_exists('showPortCats')) {
    function showPortCats($post_type_terms = "")
    {
        ...
        if ($count > 0) {
            ...
            $term_list .= '<a href="' . $permalink . '" data-option-value="*">' . __('All', 'gt3_builder') . '</a>
		</li>';
            ...
            if (is_array($terms)) {
                foreach ($terms as $term) {
                    ...
                    $term_list .= '><a href="' . $permalink . '" title="'.__('View all post filed under', 'gt3_builder').' ">' . $term->name . '</a>                    
                </li>';
            ...
            return '<ul class="optionset">' . $term_list . '</ul>';
        }
    }
}
