...
<div class='pop_scrollable_area'>
    ...
    <div class='padding-cont diagram_admin'>
		<div class='gt3_floated_option diagram_bg_wrapper'><h5>" . __('Bar Background', 'gt3_builder') . ":</h5>" . colorpicker_block("pagebuilder[modules][$moduleid][diagram_bg]", (isset($gt3_theme_pagebuilder['modules'][$moduleid]['diagram_bg']) ? $gt3_theme_pagebuilder['modules'][$moduleid]['diagram_bg'] : 'e9ebec')) . "</div>
		<div class='gt3_floated_option diagram_bg_wrapper'><h5>" . __('Bar Color', 'gt3_builder') . ":</h5>" . colorpicker_block("pagebuilder[modules][$moduleid][diagram_color]", (isset($gt3_theme_pagebuilder['modules'][$moduleid]['diagram_color']) ? $gt3_theme_pagebuilder['modules'][$moduleid]['diagram_color'] : '2898ac')) . "</div>
		<div class='gt3_floated_option'>" . get_module_settings_part_input($gt3_theme_pagebuilder, $moduleid, $pb_module_size_now, $GLOBALS["pbconfig"], __('Bar Width:', 'gt3_builder'), "bar_width", "95px", "left", "3px") . "</div>
		<div class='gt3_floated_option'>" . get_module_settings_part_input($gt3_theme_pagebuilder, $moduleid, $pb_module_size_now, $GLOBALS["pbconfig"], __('Bar Size:', 'gt3_builder'), "diagram_size", "95px", "left", "69px") . "</div>
		<div class='gt3_floated_option'>" . get_module_settings_part_input($gt3_theme_pagebuilder, $moduleid, $pb_module_size_now, $GLOBALS["pbconfig"], __('Font Size:', 'gt3_builder'), "percent_size", "95px", "left", "15px") . "</div>
		<div class='clear'></div>
...
<div class='pop_scrollable_area'>
    ...
    <div class='padding-cont'>
        ...
        " . get_module_settings_part_select_with_caption($gt3_theme_pagebuilder, $moduleid, $pb_module_size_now, $GLOBALS["pbconfig"], __("View type", "gt3_builder"), "view_type", "200px", $GLOBALS["pbconfig"]['all_blogpost_types']) . "		
...
<div class='pop_scrollable_area'>
    ...
    <div class='padding-cont'>
		...
		" . get_module_settings_part_select_with_caption($gt3_theme_pagebuilder, $moduleid, $pb_module_size_now, $GLOBALS["pbconfig"], "Button target", "button_target", "200px", $GLOBALS["pbconfig"]['all_available_targets']) . "		
...
<div class='pop_scrollable_area'>
    ...
    <div class='padding-cont'>
		...
		" . get_module_settings_part_input($gt3_theme_pagebuilder, $moduleid, $pb_module_size_now, $GLOBALS["pbconfig"], __("Counter text", "gt3_builder"), "stat_heading", "100%", "left") . "
        " . get_module_settings_part_padding_bottom($gt3_theme_pagebuilder, $moduleid) . "
        <div class='clear'></div>
    </div>
    " . get_module_settings_part_done_btn() . "
