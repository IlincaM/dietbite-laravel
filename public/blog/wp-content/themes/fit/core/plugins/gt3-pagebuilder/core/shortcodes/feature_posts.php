        ...
        ';
            ...
            while ($wp_query->have_posts()) : $wp_query->the_post();
                ...
                if (strlen($featured_image[0]) > 0) {
                    ...
                    $featured_image_full = '<div class="img_block wrapped_img"><a href="' . get_permalink(get_the_ID()) . '"><img src="' . $featured_image_url . '" /><div class="featured_item_fadder"></div><span class="ico_plus"></span></a></div>';
                } else {
                    $featured_image_full = '';
                }
                        ...
                        <div class="item">
                            ...
                            <div class="featured_items_body featured_posts_body">
                                <div class="featured_items_title">
                                    <h5><a href="' . get_permalink(get_the_ID()) . '">' . get_the_title() . '</a>
