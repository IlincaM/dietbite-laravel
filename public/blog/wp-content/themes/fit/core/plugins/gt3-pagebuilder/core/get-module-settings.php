...
function get_module_settings_part_heading($gt3_theme_pagebuilder, $moduleid, $pb_module_size_now)
{
    ...
    <div class='padding-cont'>
        <div class='heading'>
            ...
            <input type='text' class='textoption type1' value='".esc_attr($gt3_theme_pagebuilder['modules'][$moduleid]['heading_text'])."' name='pagebuilder[modules][$moduleid][heading_text]'>
        </div>
        <div class='alignment'>
        ...
        <div class='heading_color'>
            ...
            " . colorpicker_block("pagebuilder[modules][$moduleid][heading_color]", (isset($gt3_theme_pagebuilder['modules'][$moduleid]['heading_color']) ? esc_attr($gt3_theme_pagebuilder['modules'][$moduleid]['heading_color']) : '')) . "
        </div>
        <div class='clear'></div>
    </div>
    ...
    if (isset($gt3_theme_pagebuilder['modules'][$moduleid][$settingname]) && is_array($gt3_theme_pagebuilder['modules'][$moduleid][$settingname])) {
        foreach ($gt3_theme_pagebuilder['modules'][$moduleid][$settingname] as $key => $value) {
            ...
            <div class='stand_iconsweet ui-state-default'>
                ...
                <span class='remove_me'><i class='remove_any_icons icon-times'></i></span>
            </div>";
        }
    }
