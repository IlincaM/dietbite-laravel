...
#GALLERY AREA
	...
	if ($now_post_type == "page" && (get_page_template_slug() == "page-portfolio-grid.php")) {
		echo "
			<style>
				.edit-form-section, #pb_section, #side_sidebar_settings_meta_box {
    ...
    if ($now_post_type == "page" && (get_page_template_slug() == "page-gallery-wall.php" || get_page_template_slug() == "page-gallery-masonry.php" || get_page_template_slug() == "page-gallery-fw.php")) {
        echo "
        <!-- FULLSCREEN SLIDER SETTINGS -->
                <div class='padding-cont  stand-s pt_" . $now_post_type . "'>
                    <div class='bg_or_slider_option slider_type active'>
		...
		if ($now_post_type == "page" && (get_page_template_slug() == "page-gallery-fw.php" || get_page_template_slug() == "page-gallery-masonry.php")) {
			echo "
				<style>
        ...
        if (isset($gt3_theme_pagebuilder['strips']) && is_array($gt3_theme_pagebuilder['strips'])) {
            ...
            <li class="strip_block">
				...
				<div class="strip_block_container"><input type="text" placeholder="Title 1" name="pagebuilder[strips]['. $stripid .'][striptitle1]" value="' . (!empty($stripdata['striptitle1']) ? $stripdata['striptitle1'] : "") . '" class="strip_input">
					<input type="text" placeholder="Title 2" name="pagebuilder[strips]['. $stripid .'][striptitle2]" value="' . (!empty($stripdata['striptitle2']) ? $stripdata['striptitle2'] : "") . '" class="strip_input"><input type="text" placeholder="Button Text" name="pagebuilder[strips]['. $stripid .'][linktext]" value="' . (!empty($stripdata['linktext']) ? $stripdata['linktext'] : "") . '" class="strip_input"><input type="text" placeholder="Link" name="pagebuilder[strips]['. $stripid .'][link]" value="' . (!empty($stripdata['link']) ? $stripdata['link'] : "") . '" class="strip_input">
...
#FS BLOG & FS PORTFOLIO
    if ($now_post_type == "page" && (get_page_template_slug() == "page-blog-fullscreen.php" || get_page_template_slug() == "page-portfolio-fullscreen.php")) {
        echo "
            <!-- FS BLOG or FS PORTFOLIO -->
            <div class='padding-cont pt_" . $now_post_type . "' style='margin-top:20px;'>

            <div class='strip_cont gt3settings_box'>";
			if (get_page_template_slug() == "page-blog-fullscreen.php") {
				echo "<div class='gt3settings_box_title'><h2>Fullscreen Blog Options</h2></div>";
			} else {
				echo "<div class='gt3settings_box_title'><h2>Fullscreen Portfolio Options</h2></div>";
			}
				
		echo "<div class='gt3settings_box_content'>
				<div class='fs_fit_select'><h2>" . __('Posts On Screen:', 'gt3_builder') . "</h2>
						<input type='text' class='medium textoption type1' name='pagebuilder[settings][postsonpage]' value='" . (isset($gt3_theme_pagebuilder['settings']['postsonpage']) ? $gt3_theme_pagebuilder['settings']['postsonpage'] : "") . "'>
...
#FS CONTACT AREA
    if ($now_post_type == "page" && get_page_template_slug() == "page-contact.php") {
        echo "
            ...
            <div class='strip_cont gt3settings_box'>
				<div class='gt3settings_box_title'><h2>Contacts Options</h2></div>
				<div class='gt3settings_box_content'>";
...
#FULLSCREEN GALLERY AREA
    if ($now_post_type == "page" && (get_page_template_slug() == "page-fullscreen-slider.php" || get_page_template_slug() == "page-gallery-kenburns.php")) {
        echo "
        <!-- FULLSCREEN SLIDER SETTINGS -->
                <div class='padding-cont  stand-s pt_" . $now_post_type . "'>
                    <div class='bg_or_slider_option slider_type active'>
            ...
            echo "<div style='width: 190px;' class='caption'><h2 style='color:#A1A1A1;' class='text-shadow2'>" . __('Show Thumbnails:', 'gt3_builder') . "</h2></div>
...
<br />
									<div style='width: 190px;' class='caption'><h2 style='color:#A1A1A1;' class='text-shadow2'>" . __('Autoplay:', 'gt3_builder') . "</h2></div>
										...
										<input type='text' class='medium textoption type1' name='pagebuilder[sliders][fullscreen][interval]' value='" . (isset($gt3_theme_pagebuilder['sliders']['fullscreen']['interval']) ? $gt3_theme_pagebuilder['sliders']['fullscreen']['interval'] : "") . "'>										
									</div>
								</div>
								<style>
									.inter_edit {
