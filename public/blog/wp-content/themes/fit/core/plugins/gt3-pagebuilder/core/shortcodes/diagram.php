			...
			<script>
				jQuery(document).ready(function($) {					
					jQuery('.chart').each(function(){
						...
						jQuery(this).parents('.skill_item').css({'padding-left' : (parseInt(jQuery(this).parents('.skills_list').attr('data-size'))+31)+'px', 'min-height' : parseInt(jQuery(this).parents('ul.skills_list').attr('data-size'))+30+'px'});
					});
