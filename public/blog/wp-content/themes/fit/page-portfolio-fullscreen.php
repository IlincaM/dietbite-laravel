<?php 
/*
Template Name: Fullscreen Portfolio
*/
                        ...
                        <div class="fs_listing_content">
                        	<div class="fs_content_wrapper">
                                <section class="fs_blog_top">
                                    <h5><a class="fs_listing_title" href="<?php echo $linkToTheWork; ?>"><?php the_title(); ?></a></h5>
                                </section>
                                <article class="fs_listing_content contentarea">
                                    <?php echo get_the_excerpt(); ?> <a class="blogpost_readmore" href="<?php echo $linkToTheWork; ?>"><?php echo __('Read more!', 'theme_localization') ?></a>
                                </article>
                            </div>
                        </div>
					</div>
