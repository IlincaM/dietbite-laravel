	...
	<footer class="entry-meta entry-footer">
		<?php
			...
			if ( ! athemes_categorized_blog() ) {
				...
				if ( '' != $tag_list ) {
					$meta_text = __( '<span class="cat-links">%1$s</span><span class="tags-links"><i class="ico-tags"></i> %2$s</span>', 'athemes' );
				} else {
					$meta_text = __( '<span class="cat-links">%1$s</span>', 'athemes' );
				}
